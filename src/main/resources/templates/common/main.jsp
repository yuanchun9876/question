...
<body class="hold-transition skin-blue sidebar-mini">
	            ...
	            <ul class="dropdown-menu">
	              ...
	              <li class="user-footer">
	                ...
	                <div class="pull-right">
	                  <a href="<%=request.getContextPath() %>/login.jsp" class="btn btn-default btn-flat">退出</a>
	                </div>
	              </li>
	            </ul>
	          </li>
    ...
    <!-- sidebar: style can be found in sidebar.less -->
	    <section class="sidebar">
	      ...
	      <ul class="sidebar-menu" data-widget="tree">
	        <li class="treeview" >
		            ...
		            <li >
		            	<a href="<%=request.getContextPath() %>/example/list.html"  target="ifr_content"  >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >列表页面</span>
		            	</a>
		            </li>
		            <li >
		            	<a href="<%=request.getContextPath() %>/example/add.html" target="ifr_content" >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >添加页面</span>
		            	</a>
		            </li>
		            <li >
		            	<a href="dashboard.html" target="ifr_content" >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >导航页面</span>
		            	</a>
		            </li>
		            ...
		            <li >
		            	<a href="<%=request.getContextPath() %>/qstn/addPage.action" target="ifr_content" >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >新增试题</span>
		            	</a>
		            </li>
		            ...
		            <li >
		            	<a href="<%=request.getContextPath() %>/subjUnit/query.action" target="ifr_content" >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >知识章</span>
		            	</a>
		            </li>
		            <li >
		            	<a href="<%=request.getContextPath() %>/subjSctn/query.action" target="ifr_content" >
		            		<i class="glyphicon glyphicon-record"></i>
		            		<span >知识节</span>
		            	</a>
		            </li>
	  ...
	  <div class="content-wrapper">
	  	<iframe  name="ifr_content"   src="dashboard.html"   style="width:100%;height:580px;border:0px solid;"  ></iframe>
	  </div>
