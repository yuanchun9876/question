         ...
         <form name="infoForm" id="queryForm" method="post" >
        	<div class="box-header clearfix">
				<div class="box-search btn-group">
					...
					<button class="btn btn-warning" name="delBtn"  onclick="dels()" >删除</button>
				</div>
        	</div>
        	</form>
        	<!-- /.box-header -->
        	<div class="box-body no-padding">
        		...
        		<form name="delForm"  method="post"  action="<%=request.getContextPath()%>/subj/dels.action">
        	
        			<c:forEach items="${list }" var="subj" varStatus="i">
        			<tr >
        			  <td >${i.count }</td>
        			  <td ><input type="checkbox" name="ids"  value="${subj.subjId }"></td>
...
<!-- ./wrapper -->
	...
	function addPage(){
		location.href = "<%=request.getContextPath()%>/subj/addPage.action"; 
	}
