		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="row">
						<form class="form form-horizontal" method="post"    action="<%=request.getContextPath() %>/subj/addSave.action"  >
							<!-- left column -->
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="subjTitle"  placeholder="请您输入科目名称" required="required">
											</div>
										</div>
									
										<div class="form-group">
											<label for="cardid" class="col-sm-2 control-label">科目序号</label>
											<div class="col-sm-10">
												<input type="number" class="form-control" name='subjNum' placeholder="请您输入科目序号"  required="required">
											</div>
										</div>
